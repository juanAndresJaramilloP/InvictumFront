            ...
            <div className="hero min-h-screen bg-base-200">
                <div className="hero-content text-center mb-80">
                    <div className="max-w-xl">
                        <h1 className=" text-3xl sm:text-5xl font-bold"><FormattedMessage id='Bienvenido' />, {name}</h1>
                        <p className="py-6 sm:text-lg text-base"><FormattedMessage id="SubirReporte" /></p>
                                ...
                                <form className="card-body">
                                    <div className="flex flex-col lg:flex-row justify-center items-center">
                                        <label className="input input-bordered flex items-center gap-2">
                                            ...
                                            <input type="email" className="grow" placeholder="myclient@email.com" value={clientEmail} onChange={handleEmailChange} required />
                                        </label>
                                        <button className="btn mt-2 lg:mt-0 lg:ml-1 btn-primary" onClick={validateClient}><FormattedMessage id="BuscarCliente" /></button>
                                    </div>
                                    {!isEmailValid && <p className="text-red-500"><FormattedMessage id='CorreoInvalido' /></p>}
                                    <div className="form-control mt-6">
                                        {isRoleValid ? (
                                            ...
                                            <div className='flex flex-col justify-center items-center'>
                                                <input type="text" placeholder="Title" className="input input-bordered w-full max-w-xs mb-2" required disabled />
                                                ...
                                                <button className="btn mt-7 max-w-fit" disabled="disabled"><FormattedMessage id='subirArchivo'/></button>
                                            </div>
                                        )}
                                    </div>
                                </form>
