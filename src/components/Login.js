...
const Login = () => {
    ...
    const validatePassword = (paswd) => {
        const isValid = (paswd.length > 4);
                        ...
                        <form className="card-body">
                            ...
                            <div className="form-control">
                                ...
                                <label className="input input-bordered flex items-center gap-2">
                                    ...
                                    <input type="password" className="grow" value={password} onChange={handlePasswordChange} isValid={!isPasswordValid} required/>
                                    {!isPasswordValid && <label className="label">Your password should have numbers and letters and should be at least 9 characters long.</label>}
                                </label>
                            </div>
                            ...
                            <div className="form-control mt-6">
                                <button className="btn btn-outline" onClick={handleCreateAccount}>Crear Cuenta</button>
                            </div>
                        </form>
                    </div>
                </div>
